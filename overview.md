...
- 已生成本地 Windows x64 NSIS 安装包：`src-tauri/target/release/bundle/nsis/NewAPI监控_1.0.4_x64-setup.exe`（约 4.2 MB）。
- 修复设置页仓库链接：通过 `tauri-plugin-opener` 调用系统默认浏览器打开 GitHub 仓库。
